...
[CreateAssetMenu(fileName = "New Resource Manager", menuName = "Resource Manager")]
public class ResourceManager : ScriptableObject
{
    ...
    [Tooltip("This location's total population. ")] private int population = 0;
    [Tooltip("This location's total total food. ")] private int food = 0;
    [Tooltip("This location's total total crime rate. ")] private int crimeRate = 0;
    [Tooltip("This location's total cult presence. ")] private int cultPresence = 0;
